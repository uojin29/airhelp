...
export default function DepartBookingForm() {
  ...
  return (
    <>
      {/* <Header /> */}
      <DepartContainer>
        <Title>공항 출발 예약 (On-Line Departure Reservation) </Title>
        {/* <TextDetail> */}
        ...
        <>
          <Form name="productUpload" onFinish={onSubmit}>
            ...
            <Grids>
              <TextGrids>
                <TextButton> 출발 정보 </TextButton>
                <Texts>
                  <TextTitle>공항 도착 시간</TextTitle>
                  <TextDetail>(Airport Arrival Date & Time)</TextDetail>
                </Texts>
              </TextGrids>
              <InputForm>
                <Form.Item name="airport_arrival_time">
                  <Input
                    size="large"
